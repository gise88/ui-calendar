	...
	.controller('uiCalendarCtrl', ['$scope',
		...
		function(
			...
			this.eventsFingerprint = function(e) {
				...
				//console.log("eventsFingerprint", e);
				...
				var applyChanges = function(newTokens, oldTokens) {
					...
					for (i = 0, n = removedTokens.length; i < n; i++) {
						...
						if (newToken === removedToken) {
							...
							self.onChanged(el);
							//console.log("ctrl-2", newToken, removedToken, el);
						}
					}
					...
					subscribe: function(scope, onChanged) {
						scope.$watch(getTokens, function(newTokens, oldTokens) {
							if (!onChanged || onChanged(newTokens, oldTokens) !== false) {
								//console.log("ctrl-1", newTokens, oldTokens);
		...
		function(uiCalendarConfig, $timeout) {
			return {
				...
				scope: {
					...
					calendarWatchEvent: '=calendarWatchEvent'
				},
				...
				link: function(scope, elm, attrs, controller) {
					...
					eventsWatcher.onChanged = function(event) {
						var fcEventSlots = calendar.fullCalendar('clientEvents', event.id);
					...
					scope.$watch(getOptions, function(newO, oldO) {
						if (scope.calendar && scope.calendar.fullCalendar) {
							var date = scope.calendar.fullCalendar('getDate');
